        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              I am a dedicated front-end developer with expertise in React, Redux, HTML, CSS, JavaScript, and Java. 
              I specialize in building responsive, dynamic, and user-friendly web applications, transforming design 
              concepts into interactive digital experiences. Passionate about continuous learning, I stay updated 
              with the latest industry trends to enhance my skill set and deliver high-quality solutions.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <img src="/images/resume.png" alt="Resume" className="w-16 h-16 mb-2" />
              ...
              <a
                ...
                className="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <img src="/images/leet.png" alt="LeetCode" className="w-16 h-16 mb-2" />
